...
addpath(genpath(fullfile(parent_dir, 'data')));
addpath(genpath(fullfile(parent_dir, 'training/trans')));
...
[encoderInput, decoderInput, decoderTarget, encoderEmbeddings, decoderEmbeddings] = preprocessSeqTrain(seq_train, batchSize, embeddingDim, params);
...
seq_net = params;
save('seq_net.mat', 'seq_net', 'lossHistory');