function [popout, fit] = Transformer_aco_LDOA(pop, data, info, aco_net, fit)
[pop_size, ~] = size(pop);
[pop1, len_LSTM_aco, dlX_all, dlZ_all] = Transformer_aco_reduction(pop, info, data, aco_net);
[info, pop2] = RL_GA_cross(pop1, info, fit);
[info, pop3] = RL_GA_mutation2(pop2, info);
popout = Transformer_aco_rise(pop3, data, aco_net, len_LSTM_aco, dlX_all, dlZ_all);
