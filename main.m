...
addpath(genpath(fullfile(parent_dir, 'train_RL')));
addpath(genpath(fullfile(parent_dir, 'train_Trans')));
...
max_total_time = info.maxrt;
max_task_time = max_total_time / n;
tic

for x = 1 : n
    task_start_time = toc;
    task_end_time = task_start_time + max_task_time;
